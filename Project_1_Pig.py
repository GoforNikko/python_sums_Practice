...
# Have some random number generator between 1 to 6
# ask the user if they wanna continue to roll 
# either roll again or stop their turn
# if stop take whatever their score is and add that to total score
# constantly check if either player has a score that is above 50
# if above 50 end the game 
# user won
#
